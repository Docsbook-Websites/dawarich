...
| Environment Variable | Default Value | Description |
| -------------------- | ------------- | ----------- |
| `PHOTON_API_HOST` | `nil` | Photon API host. Useful if you're self-hosting your [own Photon instance](./configuration/reverse-geocoding.md#setting-up-your-own-reverse-geocoding-service) |
...
For detailed setup instructions, see the [OIDC Authentication Tutorial](./configuration/oidc-authentication.md).
