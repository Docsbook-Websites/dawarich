...
For a Synology install, refer to **[Synology Install Tutorial](../installation/synology.md)**. In this page, it is explained how to set the APPLICATION_HOSTS environment variable.
