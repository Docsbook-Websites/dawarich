---
title: "Install Dawarich on Kubernetes"
description: "Deploy Dawarich on a Kubernetes cluster with YAML manifests: namespace, persistent volume claims, deployments, services and ingress."
---

> **Where this page came from**
>
> This guide lives in the `docs/` folder of the [main Dawarich repository](https://github.com/Freika/dawarich/tree/master/docs) and has never been published on the documentation site. It is reproduced here unchanged so that it sits next to the other installation guides and can be found by search.
