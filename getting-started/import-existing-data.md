...
>
>
> Importing process also starts reverse geocoding process for each point imported. This process can take a while, depending on the number of points imported. For more info on reverse geocoding, refer to the [Reverse geocoding guide](../self-hosting/configuration/reverse-geocoding.md).
>
...
![Imports](https://raw.githubusercontent.com/dawarich-app/site/main/docs/getting-started/new-import.png)
