...
You can run Dawarich directly on Home Assistant as a native app — no separate server needed. See the [Home Assistant installation guide](../self-hosting/installation/home-assistant.md).
