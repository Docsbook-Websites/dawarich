...
<details>
  ...
  Yes. The official Dawarich [iOS](./getting-started/dawarich-for-ios.md) and [Android](./getting-started/dawarich-for-android.md) apps record your location on the device itself, so tracking keeps running even when your phone has no signal — on a plane, underground, hiking off-grid, or travelling abroad without data.
