...
The feature is enabled by default when a [reverse geocoding service](../self-hosting/configuration/reverse-geocoding.md) is configured.
...
1. Use the [Search feature](./search.md) to find a location
