...
- **Search functionality** - Built-in place search (see [Search](./search.md))
...
![Points](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/map-points.webp)
...
![Polylines](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/map-polylines.webp)

### Heatmap

Visualizes point density as a heatmap, showing areas where you spend the most time.

![Heatmap](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/map-heatmap.webp)

### Fog of War

Shows unexplored areas as "fog," revealing only the regions you've visited. Great for visualizing your travel coverage.

![Fog of war](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/map-fog-of-war.webp)

### Scratch Map

Highlights countries you've visited on a world map overlay.

![Scratch map](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/map-scratch-map.webp)

### Areas

Shows [custom areas](./areas.md) you've drawn on the map. Also enables area drawing tools.

![Areas](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/map-areas.webp)

### Photos

Displays photos from connected [Immich and/or Photoprism](./photos.md) instances at their GPS locations.

![Photos](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/map-photos.webp)

### Family (Map V2)

When you have [Family Location Sharing](./family.md) enabled, shows real-time locations of family members who are sharing their location with you.
...
Map V2 includes a built-in place search feature. See the [Search documentation](./search.md) for details.
