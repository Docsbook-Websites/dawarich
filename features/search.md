...
For search to work, you must have reverse geocoding enabled. See the [Reverse Geocoding](../self-hosting/configuration/reverse-geocoding.md) tutorial for setup instructions.
