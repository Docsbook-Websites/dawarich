...
![Imports](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/imports.png)
...
- See [Photos](./photos.md) for setup
...
3. See [Reverse Geocoding](../self-hosting/configuration/reverse-geocoding.md) for rate limits
...
Click **New Import** on the Imports page to upload a file. For detailed instructions, see the [Import Existing Data](../getting-started/import-existing-data.md) tutorial.
