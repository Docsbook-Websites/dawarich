...
![Points](https://raw.githubusercontent.com/dawarich-app/site/main/docs/features/images/points.png)
...
The export runs in the background. Once complete, the file is available on the [Exports](./exports.md) page.
