...
> **Tip**
>
> Activity breakdown requires tracks with transportation mode detection enabled. See the [Transportation Modes](./transportation-modes.md) documentation for more information.
...
This requires the [Visits and Places](./visits-and-places.md) feature to be enabled with reverse geocoding configured.
