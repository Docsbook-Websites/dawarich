...
Full schema: [Returns per-country day counts for tax residency calculations](https://dawarich.app/docs/api/returns-per-country-day-counts-for-tax-residency-calculations/).
